  ...
  return (
    <div style={{ fontFamily:"'Manrope',sans-serif", color:C.onSurface }}>
      ...
      <div style={{ display:'flex', gap:10, flexWrap:'wrap', marginBottom:16, alignItems:'center' }}>
        <div style={{ display:'flex', alignItems:'center', gap:6, background:'#f0f3ff',
          border:`1px solid ${C.outline}`, borderRadius:99, padding:'6px 14px', minWidth:160 }}>
          ...
          <input value={searchAction} onChange={e => setSearchAction(e.target.value)}
            placeholder="Filter action..." style={{ border:'none', background:'transparent', outline:'none', fontSize:13, width:130 }} />
        </div>
        <div style={{ display:'flex', alignItems:'center', gap:6, background:'#f0f3ff',
          border:`1px solid ${C.outline}`, borderRadius:99, padding:'6px 14px', minWidth:160 }}>
          ...
          <input value={searchEmail} onChange={e => setSearchEmail(e.target.value)}
            placeholder="Filter user email..." style={{ border:'none', background:'transparent', outline:'none', fontSize:13, width:140 }} />
        </div>
        <select value={searchResource} onChange={e => setSearchResource(e.target.value)} style={inputStyle}>
          <option value="">All Resources</option>
          <option value="User">User</option>
          <option value="Project">Project</option>
        </select>
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          <label style={{ fontSize:12, color:C.onVariant, fontWeight:600 }}>From:</label>
          <input type="date" value={fromDate} onChange={e => setFromDate(e.target.value)} style={inputStyle} />
        </div>
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          <label style={{ fontSize:12, color:C.onVariant, fontWeight:600 }}>To:</label>
